...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="LLM provider (openrouter, openai, azure, openai_compatible, bedrock, transformers)",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Embedding provider (openai, azure, openai_compatible, local, cohere, transformers, vllm)",
    )
    parser.add_argument(
